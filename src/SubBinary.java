...
public class SubBinary {
	...
	/**
	 * Makes the 2's complement of the binary number
	 * @param binary the number we want to transform
	 * @return the transformed number
	 */
	public static int[] twoComplement(int[] binary){
	...
	public static void main(String[] args) {
		...
		binaryNum2 = twoComplement(binaryNum2);
